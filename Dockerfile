...
#RUN sudo apk add --allow-untrusted /home/abuild/packages/tmp/x86_64/mozjpeg*.apk
...
RUN sudo chown abuild:abuild ./ && abuild checksum
RUN abuild -r -i || abuild -r -i
#RUN sudo apk add --allow-untrusted /home/abuild/packages/tmp/x86_64/tiff*.apk
...
RUN sudo chown abuild:abuild ./ && abuild checksum
RUN abuild -r -i || abuild -r -i
#RUN sudo apk add --allow-untrusted /home/abuild/packages/tmp/x86_64/lcms*.apk
